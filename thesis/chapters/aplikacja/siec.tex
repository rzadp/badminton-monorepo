...
Do każdego z nich został dołączony plik \texttt{via\_region\_data.json} zawierający anotacje kortów na obrazie, stworzony za pomocą anotatora opisanego w \myrefx{sec:anotator}.
