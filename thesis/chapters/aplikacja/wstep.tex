...
\begin{itemize}
  ...
  \item Skrypt służący do obliczenia skuteczności sieci, według miar opisanych w rozdziale \myrefx{sec:miary}
\end{itemize}
...
\begin{enumerate}
 ...
 \item Uruchomienie skryptu do trenowania, testując różne podziały na zbiory treningowe i walidacyjne\footnote{Patrz rozdział \myrefx{sec:podzial}}. Podział dający najlepsze rezultaty wykorzystano w kolejnych eksperymentach;
