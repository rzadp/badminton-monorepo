...
Interfejs użytkownika pozwala na poruszanie pozycją oraz kierunkiem patrzenia wirtualnej kamery w trójwymiarowej scenie, a także zapis rysowanej sceny na dysku. Do tego możliwe jest losowe przemieszczenie zawodników na kortach. Dodatkowe funkcje pomocne w czasie tworzenia generatora służą do pokazania osi wymiarów X, Y i Z w wirtualnej scenie oraz podgląd anotacji obszaru kortów. Przykłady sztucznie wygenerowanych obrazów zostały przedstawione na Rysunku \numberref{fig:fake}, Rysunku \numberref{fig:annotated_fake}, Rysunku \numberref{fig:fakemultiple} oraz na Rysunku \numberref{fig:fakemultipleannotated}.
