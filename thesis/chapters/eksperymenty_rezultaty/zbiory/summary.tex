% !TeX root = ../../main.tex
\subsection{Podsumowanie eksperymentów z podziałami zbiorów danych}

Podsumowując wyniki uzyskane w poprzednich podrozdziałach, wyniki przedstawiono na wykresie.
...
Dla obu zbiorów najwyższy wynik na podzbiorze testowym został uzyskany w przypadku podział podzbioru treningowego i walidacyjnego w stosunku odpowiednio 90:10, dlatego też zbiory danych zostały podzielone w takim stosunku.
