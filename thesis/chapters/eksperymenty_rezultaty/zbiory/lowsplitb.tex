...
Dokładność modelu mierzona na zbiorze walidacyjnym (\textbf{96.6\%}) jest marginalnie wyższa w porównaniu do wyników na zbiorze testowym (\textbf{96.1\%}), przy nieznacznie wyższej wartości czułości na zbiorze testowym.
