...
\newcommand*{\resultssummarysplit}[2]{W analizowanym przypadku wynik wskazuje, iż dokładność rozpoznawania obszaru kortu jest na poziomie \textbf{#1\%} pikseli na zbiorze walidacyjnym oraz \textbf{#2\%} na zbiorze testowym.}
