...
\begin{table}[H]
	\centering
	\caption{Wyniki podział zbioru \textit{low} w stosunku 155:52 na zbiorze walidacyjnym}
	\vspace{6pt}
	{\footnotesize
...
\begin{table}[H]
	\centering
	\caption{Wyniki podział zbioru \textit{low} w stosunku 155:52 na zbiorze testowym}
	\vspace{6pt}
	{\footnotesize
		\begin{tabular}{|c|c|c|c|c|}
      \hline \textbackslash & Accuracy & Sensitivity & Specificity & Precision \\
