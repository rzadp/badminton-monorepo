% !TeX root = ../../main.tex
\subsection{Zmodyfikowana implementacja trenowana na zbiorze \textit{low} z wygenerowanymi obrazami}
\resultsintro{\resultsmodified}{low}{\withgenerated}
\resultstables{Tab:low_modified_generated}{Tab:low_modified_generated_calculated}
\lowprocent
...
\begin{table}[H]
	\centering
	\caption{łożone wyniki sieci \textit{Mask R-CNN} na zbiorze \textit{low} ze sztucznymi obrazami}
	\vspace{6pt}
	{\footnotesize
		\begin{tabular}{|c|c|c|c|c|}
