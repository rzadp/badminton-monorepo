% !TeX root = ../../main.tex
\subsection{Zmodyfikowana sieć trenowana na zbiorze \textit{low\_186\_21} ze sztucznymi obrazami}
\label{sec:results_low_modified_generated}
\resultsintro{\resultsmodified}{low\_186\_21}{\withgenerated}
...
\lowprocent{Tab:low_modified_generated}
...
\resultssummaryalt{97.7}{99.9}
W stosunku do wyników z~Rozdziału \numberref{sec:results_low_original_generated} uzyskano wyższą dokładność oraz czułość, przy zachowaniu zbliżonego poziomu swoistości i precyzji.
Niemal wszystkie wartości wyników wskazują na poprawę skuteczności sieci w stosunku do wyników z~Rozdziału \numberref{sec:sec:results_low_modified}.
