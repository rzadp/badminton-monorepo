% !TeX root = ../../main.tex
\subsection{Sieć \textit{Mask R-CNN} trenowana na zbiorze \textit{low\_186\_21}}
\resultsintro{\resultsoriginal}{low\_186\_21}{}
\lowresultstables{Tab:low_original}{Tab:low_original_calculated}
\lowprocent

\begin{table}[H]
  \centering
	\caption{Wyniki sieci \textit{Mask R-CNN} na zbiorze \textit{low\_186\_21}}
	\vspace{6pt}
	{\footnotesize
