...
\label{sec:results_low_modified}
...
\resultssummaryalt{95.5}{98.7}
W stosunku do wyników z Rozdziału \numberref{sec:results_low_original} wyniki są marginalnie różne w przypadku średniej dokładności, swoistości i precyzji.
Natomiast jeśli chodzi o czułość, uzyskano wyższy wynik o \textbf{0.7} punktów procentowych, co wynika z mniejszej ilości przypadków fałszywie negatywnych. Warto podkreślić, iż mimo iż uzyskano wyższą średnią czułość, to mediana czułości spadła o \textbf{2.6} punkty procentowe.
