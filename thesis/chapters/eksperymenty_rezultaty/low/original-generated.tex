% !TeX root = ../../main.tex
\subsection{Sieć \textit{Mask R-CNN} trenowana na zbiorze \textit{low\_186\_21} ze sztucznymi obrazami}
\label{sec:results_low_original_generated}
\resultsintro{\resultsoriginal}{low\_186\_21}{\withgenerated}
\lowresultstables{Tab:low_original_generated}{Tab:low_original_generated_calculated}
...
\lowprocent{Tab:low_original_generated}
...
\resultssummaryalt{96.2}{100}
W stosunku do wyników z~Rozdziału \numberref{sec:results_low_original} i Rozdziału \numberref{sec:results_low_modified} wyniki są nieznacznie lepsze w przypadku średniej dokładności (wzrost odpowiednio o \textbf{0.7\%} i \textbf{0.9\%} punktów procentowych), jednak znacznie wyższe jeśli chodzi o~precyzję. Warto podkreślić, iż czułość w~porównaniu do wyników z~Rozdziału \numberref{sec:results_low_modified} jest na tym samym poziomie \textbf{91.2-91.3\%}.
Minimum dokładności, czułości, swoistości oraz precyzji jest wyższe w~porównaniu do wyników z~Rozdziału \numberref{sec:results_low_original}.
