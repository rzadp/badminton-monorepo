...
W stosunku do wyników z Rozdziału \numberref{sec:results_low_original} i Rozdziału \numberref{sec:results_low_modified} wyniki są nieznacznie lepsze w przypadku dokładności (wzrost odpowiednio o \textbf{0.7\%} i \textbf{0.9\%} punktów procentowych), jednak znacznie wyższe jeśli chodzi o prezycję. Warto podkreślić, iż czułość w porównaniu do wyników z Rozdziału \numberref{sec:results_low_modified} jest na tym samym poziomie \textbf{91.2-91.3\%}.
