...
\resultssummaryalt{96.8}{86.7}
W stosunku do wyników z Rozdziału \numberref{sec:results_high_original} wyniki są marginalnie lepsze jeśli chodzi o dokładność, jednocześnie nieznacznie gorsze w przypadku swoistości i precyzji. Czułość okazała się wyższa o \textbf{2.5} punktów procentowych. Minimum czułości i precyzji na poziomie \textbf{0\%} oznacza, że dla jednego z obrazów kort nie został wykryty wcale.
