...
W stosunku do wyników z Rozdziału \numberref{sec:results_high_original} wyniki są marginalnie lepsze jeśli chodzi o dokładność, jednocześnie nieznacznie gorsze w przypadku swoistości i precyzji. Średnia czułość okazała się wyższa o \textbf{3.8} punktów procentowych.
