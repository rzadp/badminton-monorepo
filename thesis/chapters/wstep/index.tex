...
Celem pośrednim, wynikającym z~celu głównego jest analiza istniejących rozwiązań w literaturze, rozpatrując zarówno podejścia wykorzystujące sieci neuronowe oraz rozwiązania klasyczne, to znaczy bez wykorzystania sieci. \TODO{Wymienić rozwiązania konkretnie}
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item Modyfikacja i przygotowanie sieci na potrzeby zanalizowanego zagadnienia \patrz{sec:zaproponowana_architektura}
	\end{itemize}
