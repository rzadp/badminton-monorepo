...
Pseudokod \myfigref{alg:mask-r-cnn} przybliża w jaki sposób powstaje podsieć odpowiedzialna za wykrycie maski obiektu.

\begin{algorithm}
  \vspace{0.3cm}
	\textbf{Dane wejściowe:} \\
  \hspace*{\algorithmicindent} \verb|rois| - given regions of interest in normalized coordinates \\
  \hspace*{\algorithmicindent} \verb|feature_maps| - list of feature maps from layers P2 , P3 , P4 , P5 \\
  \hspace*{\algorithmicindent} \verb|pool_size| - height of feature maps to be generated from ROIpooling \\
