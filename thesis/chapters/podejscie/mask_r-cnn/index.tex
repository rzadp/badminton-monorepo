...
Wyróżniony element wskazuje zasadniczą różnicę względem \textit{Fast R-CNN}.
...
Schemat \textit{Mask R-CNN} przedstawiony jest na Rysunku \myfigref{fig:mask_r_cnn}. Wyróżniony element wskazuje zasadniczą różnicę względem \textit{Faster R-CNN}.
