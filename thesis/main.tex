...
\renewcommand{\listalgorithmname}{Spis pseudokodów}
...
\newcommand\ddfrac[2]{\frac{\displaystyle #1}{\displaystyle #2}} % https://tex.stackexchange.com/questions/173899/fractions-with-large-elements

% Renaming floats with babel % https://latex.org/forum/viewtopic.php?t=1825
...
\newcommand*{\myrefx}[1]{\hyperref[{#1}]{\textbf{\ref*{#1}}}}
\newcommand*{\myfigref}[1]{\hyperref[{#1}]{\textbf{\ref*{#1}}}}
\newcommand*{\myrozdzial}[1]{\hyperref[{#1}]{(Rozdział~\textbf{\ref*{#1}})}}
\newcommand*{\mytabref}[1]{\hyperref[{#1}]{\textbf{\ref*{#1}}}}
\newcommand*{\myfigrefx}[1]{\hyperref[{#1}]{\textbf{\ref*{#1}}}}
\newcommand*{\numberref}[1]{\hyperref[{#1}]{\textbf{\ref*{#1}}}}
...
% \input{title_page/strona_tytulowa-jeden-autor}
...
\setcounter{page}{14} % JEŻELI Z POWODU DUŻEJ ILOŚCI STRON W SPISIE TREŚCI SIĘ NIE ZGADZA, TRZEBA ZMODYFIKOWAĆ RĘCZNIE
...
Fast R-CNN & Fast Regions with Convolutional Neural Network \\
Faster R-CNN & Faster Regions with Convolutional Neural Network \\
Mask R-CNN & Mask Regions with Convolutional Neural Network \\
\end{tabular}
\newpage
\thispagestyle{empty}
...
% \listofalgorithms
% \addcontentsline{toc}{chapter}{Spis pseudokodów}
% \newpage
% \thispagestyle{empty}
